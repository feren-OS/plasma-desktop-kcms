...
int main(int argc, char **argv)
{
    ...
    // About data
    KAboutData aboutData("qtstyletool", i18n("Theme Colouriser tool"), version, i18n("Command line tool to accompany the Theme Colouriser."), KAboutLicense::GPL, i18n("Copyright 2017, Marco Martin, 2019, The Feren OS Dev"));
    aboutData.addAuthor(i18n("The Feren OS Dev"), i18n("Maintainer"), QStringLiteral("ferenosdev@outlook.com"));
    aboutData.setDesktopFileName("org.feren.themecolourisertool");
